...
class Game {
  ...
  missileBarrage(e) {
    ...
    if(e.keyCode === 38 && this.barrageCount > 0) {
      ...
      // debugger;
      // wave 1
      let missile1 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 100, y: 700}, this.canvas, this.ctx, 135);
      let missile2 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 300, y: 700}, this.canvas, this.ctx, 135);
      let missile3 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 500, y: 700}, this.canvas, this.ctx, 135);
      let missile4 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 700, y: 700}, this.canvas, this.ctx, 135);
      // wave 2
      let missile5 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 100, y: 500}, this.canvas, this.ctx, 135);
      let missile6 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 300, y: 500}, this.canvas, this.ctx, 135);
      let missile7 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 500, y: 500}, this.canvas, this.ctx, 135);
      let missile8 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 700, y: 500}, this.canvas, this.ctx, 135);
      // wave 3
      let missile9 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 100, y: 300}, this.canvas, this.ctx, 135);
      let missile10 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 300, y: 300}, this.canvas, this.ctx, 135);
      let missile11 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 500, y: 300}, this.canvas, this.ctx, 135);
      let missile12 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 700, y: 300}, this.canvas, this.ctx, 135);
      // wave 4
      let missile13 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 100, y: 100}, this.canvas, this.ctx, 135);
      let missile14 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 300, y: 100}, this.canvas, this.ctx, 135);
      let missile15 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 500, y: 100}, this.canvas, this.ctx, 135);
      let missile16 = new __WEBPACK_IMPORTED_MODULE_0__missile__["a" /* default */]({x: 700, y: 100}, this.canvas, this.ctx, 135);
      // wave 1
...
"use strict";
class Missile {
  constructor(position, canvas, ctx, shellMax = 100) {
