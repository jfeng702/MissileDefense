...
class Game {
  constructor() {
    ...
    this.canvas.addEventListener('click', console.log('click logged'), false);
...
/* unused harmony default export */ var _unused_webpack_default_export = (new Missile);
